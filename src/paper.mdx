...
<Header
  ...
  authors={[
    ...
    { name: "Minhyek Jeon", institution: "Carnegie Mellon University", notes: ["1"] },
    { name: "Vaishnavi Khindkar", institution: "Carnegie Mellon University", notes: ["1"] },
    { name: "Ahish Deshpande", institution: "Carnegie Mellon University", notes: ["1"] },
    { name: "Celso M de Melo", institution: "ARL", notes: ["2"] },
    { name: "Shuowen Hu", institution: "ARL", notes: ["2"] },
    { name: "Shayok Chakraborty", institution: "FSU", notes: ["1", "3"] },
    { name: "Fernando De la Torre", institution: "Carnegie Mellon University", notes: ["1"] },
  ]}
  notes={[
