  ...
  authors={[
    {
      ...
      url: "https://spanev.github.io",
      institution: "Carnegie Mellon University",
      {/* notes: ["1"], */}
    },
    { name: "Minhyek Jeon", institution: "Carnegie Mellon University"},
    { name: "Vaishnavi Khindkar", institution: "Carnegie Mellon University"},
    { name: "Ahish Deshpande", institution: "Carnegie Mellon University"},
    { name: "Celso M de Melo", institution: "DEVCOM Army Research Lab"},
    { name: "Shuowen Hu", institution: "DEVCOM Army Research Lab"},
    { name: "Shayok Chakraborty", institution: "Florida State University"},
    { name: "Fernando De la Torre", institution: "Carnegie Mellon University"},
  ]}
  {/* notes={[
    { symbol: "1", text: "Carnegie Mellon University, USA" },
    { symbol: "2", text: "DEVCOM Army Research Lab, USA" },
    { symbol: "3", text: "Florida State University" },
  ]} */}
  links={[
