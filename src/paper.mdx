...
<Header
  ...
  authors={[
    ...
    { name: "Minhyek Jeon", institution: "Carnegie Mellon University", notes: ["*", "†"] },
    { name: "Vaishnavi Khindkar", institution: "Carnegie Mellon University", notes: ["*", "†"] },
    { name: "Ahish Deshpande", institution: "Carnegie Mellon University", notes: ["*", "†"] },
    { name: "Celso M de Melo", institution: "ARL", notes: ["*", "†"] },
    { name: "Shuowen Hu", institution: "ARL", notes: ["*", "†"] },
    { name: "Shayok Chakraborty", institution: "FSU", notes: ["*", "†"] },
    { name: "Fernando De la Torre", institution: "Carnegie Mellon University", notes: ["*"] },
  ]}
  notes={[
