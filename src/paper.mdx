...
import modelDiagnosis from "./assets/ModelDiagnosis.pdf"
...
## Method
<Picture src={methodDiagram} alt="Method Diagram" />
...
<Tabs defaultValue="taxonomy">
  ...
  <TabsContent value="taxonomy">
    ...
    <Picture src={taxonomy} alt="Attribute Taxonomy" width="640px" />
  </TabsContent>
